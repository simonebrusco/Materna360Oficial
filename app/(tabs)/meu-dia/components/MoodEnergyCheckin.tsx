      ...
      <div className="flex items-center gap-2 mb-3" role="group" aria-describedby="mood-subtitle">
        ...
        <div>
          ...
          <p className="text-[12px] text-[#545454]" id="mood-subtitle">
            Um registro rápido, para você se orientar.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <fieldset>
          ...
          <div className="flex gap-2">
            <button
              type="button"
              className={`rounded-xl border px-3 py-2 text-[12px] hover:bg-[#ffd8e6]/40 focus:ring-2 focus:ring-[#ffd8e6] focus:outline-none ${
                mood === 1 ? 'bg-[#ffd8e6]/60' : ''
              }`}
              onClick={() => {
                setMood(1)
