        ...
        <div>
          ...
          <div className="flex gap-2 mb-3">
            ...
            <button
              ...
              className="px-4 py-2 rounded-full bg-primary/20 text-primary font-medium text-sm hover:bg-primary/30 transition-all duração-200"
            >
              +
            </button>
          </div>
      ...
      <div onClick={(e) => e.stopPropagation()} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <button
            ...
            className="w-full px-4 py-2 rounded-full text-[#2f3a56] font-medium text-sm hover:bg-white/60 transition-all duração-200"
          >
            Limpar lista
          </button>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-2 mb-3">
            ...
            <button
              ...
              disabled={prioridadesList.length >= 5}
              className="px-4 py-2 rounded-full bg-primary/20 text-primary font-medium text-sm hover:bg-primary/30 transition-all duração-200 disabled:opacity-50"
            >
              +
            </button>
          </div>
        ...
        {checklistMaeCustomItems.length > 0 && (
          <div className="space-y-2">
            {checklistMaeCustomItems.map((item) => (
              <div
                key={item.id}
                className="flex items-center justify-between p-3 rounded-2xl bg-white/60 border border-white/40 hover:bg-white/80 transition-all duração-200"
              >
                <label className="flex items-center gap-3 flex-1 cursor-pointer">
                  <input
                    type="checkbox"
    ...
    return (
      <div onClick={(e) => e.stopPropagation()}>
        ...
        <button
          ...
          className="w-full px-4 py-2 rounded-full bg-primary text-white font-medium text-sm hover:bg-primary/90 transition-all duração-200 shadow-md"
        >
          Salvar no Planner
        </button>
      </div>
...
<span
className={text-lg font-semibold text-primary ml-3 transition-transform duração-200 flex-shrink-0 ${               expandedAccordion === card.id ? 'rotate-180' : ''             }}
>
▼
</span>
</div>
        ...
        <Reveal delay={450}>
          ...
          >
            <div className="flex items-center justify-between p-4">
              ...
              <span
                className={`text-lg font-semibold text-primary ml-3 transition-transform duração-200 ${
            ...
            {expandedAccordion === 'tarefas-recorrentes' && (
              <div className="border-t border-white/40 p-4 bg-white/30">
                ...
                <button
                  ...
                  className="mt-3 w-full px-4 py-2 rounded-full bg-primary text-white font-medium text-sm hover:bg-primary/90 transition-all duração-200 shadow-md"
                >
                  Salvar no Planner
                </button>
              </div>
