...
const cardBase =
  'flex flex-col items-start justify-between rounded-2xl bg-white/95 shadow-sm border border-[#ffd8e6] px-4 py-4 text-left transition-transform transition-shadow duration-150 hover:-translate-y-[1px] hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff005e]/60 focus-visible:ring-offset-2'

const badgeBase =
  'inline-flex items-center rounded-full bg-[#ffd8e6] px-2.5 py-0.5 text-[10px] font-medium uppercase tracking-wide text-[#2f3a56]'
  ...
  return (
    <section className="mt-4">
      <div className="mb-4 flex flex-col gap-1">
        <p className="text-xs font-semibold uppercase tracking-wide text-[#ff005e]">
          Seu ponto de partida
        </p>
        <h2 className="text-sm font-semibold text-[#2f3a56]">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <button type="button" onClick={onCuidarDeMim} className={cardBase}>
          ...
          <div className="mt-2 space-y-1">
            <p className="text-[14px] font-semibold text-[#2f3a56]">Cuidar de mim</p>
        ...
        <button type="button" onClick={onCuidarDoFilho} className={cardBase}>
          ...
          <div className="mt-2 space-y-1">
            <p className="text-[14px] font-semibold text-[#2f3a56]">Cuidar do meu filho</p>
            <p className="text-[11px] leading-snug text-gray-600">
        ...
        <button type="button" onClick={onOrganizarRotina} className={cardBase}>
          ...
          <div className="mt-2 space-y-1">
            <p className="text-[14px] font-semibold text-[#2f3a56]">Organizar o dia</p>
            <p className="text-[11px] leading-snug text-gray-600">
        ...
        <button type="button" onClick={onAprenderEBrincar} className={cardBase}>
          ...
          <div className="mt-2 space-y-1">
            <p className="text-[14px] font-semibold text-[#2f3a56]">Aprender e brincar</p>
            <p className="text-[11px] leading-snug text-gray-600">
        ...
        <button type="button" onClick={onMinhasConquistas} className={cardBase}>
          ...
          <div className="mt-2 space-y-1">
            <p className="text-[14px] font-semibold text-[#2f3a56]">Minhas conquistas</p>
            <p className="text-[11px] leading-snug text-gray-600">
        ...
        <button type="button" onClick={onPlanosPremium} className={cardBase}>
          ...
          <div className="mt-2 space-y-1">
            <p className="text-[14px] font-semibold text-[#2f3a56]">Planos e recursos</p>
            <p className="text-[11px] leading-snug text-gray-600">
