...
export default function MaternarClient() {
  ...
  return (
    <main
      ...
      bg-[#FFB3D3]
      bg-[radial-gradient(circle_at_top_left,#FF1475_0,#FF7BB1_35%,#FF4B9A_70%,#FFB3D3_100%)]"
    >
      <ClientOnly>
...
export default function MaternarClient() {
  ...
  return (
    <main
      ...
      className="min-h-[100dvh] pb-32 
      bg-[#FFB3D3]
      bg-[radial-gradient(circle_at_top_left,#9B4D96_0,#FF1475_30%,#FF7BB1_60%,#FF4B9A_82%,#FFB3D3_100%)]"
    >
      <ClientOnly>
        <div className="mx-auto max-w-3xl px-4 md:px-6">
          {/* HERO */}
