      ...
      <SectionWrapper className="pb-16">
        <div className="mx-auto flex max-w-5xl flex-col gap-8 lg:flex-row">
          ...
          <div className="flex-1 space-y-4">
            <SoftCard className="h-full bg-white/80">
              <div className="space-y-4">
                <div className="space-y-1">
                  <p className="text-xs font-medium tracking-[0.2em] text-[#545454]">
                    AJUDA & SUPORTE
                  </p>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="rounded-2xl bg-[#ffd8e6]/60 p-4">
                    ...
                    <p className="text-xs leading-relaxed text-[#545454]">
                      ...
                      sobre o Planner, XP, MaternaBox ou qualquer mini-hub.
                ...
                <div className="space-y-2 rounded-2xl border border-white/70 bg-white/90 p-4 shadow-[0_6px_22px_rgba(0,0,0,0.06)]">
                  <p className="text-xs font-medium tracking-[0.18em] text-[#545454]">
                    FAQ RÁPIDO
                  </p>
          ...
          <div className="flex-1">
            <SoftCard className="h-full bg-white/90">
              <div className="space-y-4">
                <div className="space-y-1">
                  <p className="text-xs font-medium tracking-[0.2em] text-[#545454]">
                    PARCERIAS
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <p className="text-[11px] leading-relaxed text-[#545454]">
                    Ao enviar este formulário, você não assume nenhum
                    compromisso imediato. É apenas o primeiro passo para uma
                    conversa com calma sobre como caminhar junto com o
                    Materna360.
                  </p>
                </form>
              </div>
