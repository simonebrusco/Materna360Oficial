                ...
                <section className="pb-7" id="para-agora">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {/* GRID PREMIUM: mesma altura, alinhado no estado fechado */}
                      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch">
                        {/* 0A) Acolhimento */}
                        <div className="min-h-[120px] md:min-h-[140px] h-full">
                          <ParaAgoraSupportCard variant="embedded" className="h-full" />
                        </div>

                        {/* 0B) Ação prática */}
                        <div className="min-h-[120px] md:min-h-[140px] h-full">
                          <div className="h-full rounded-2xl border border-[#f5d7e5]/70 bg-white/70 backdrop-blur px-4 py-4 shadow-[0_6px_18px_rgba(0,0,0,0.04)] flex flex-col justify-center">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div className="rounded-2xl border border-[#f5d7e5]/70 bg-white/70 px-5 py-4 shadow-[0_6px_18px_rgba(0,0,0,0.04)]">
