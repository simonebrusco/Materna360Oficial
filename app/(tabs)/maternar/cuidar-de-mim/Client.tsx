...
function pickTwoRoutines(input: { focus: FocusMode; ritmo: Ritmo; persona?: PersonaResult; altIndex: number }) {
  ...
  const secondary = chooseOne(
    seedBase + 19,
    secondaryCandidates.length ? secondaryCandidates : secondaryPool.length ? secondaryPool : pool
  )
                ...
                >
                  <div className="flex flex-col sm:flex-row items-start justify-between gap-4 items-stretch sm:items-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                      <button onClick={() => go('ritmo')} className="btn-secondary">
                        Ajustar
                      </button>

                      <button onClick={swapSuggestion} className="btn-ghost">
                        Outra opção
                      </button>

                      <button onClick={() => go('mini-rotina')} className="btn-primary">
                        Começar
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 rounded-3xl bg-white/10 border border-white/25 p-4">
                    <div className="text-[11px] text-white/80 font-semibold uppercase tracking-[0.18em]">Se não for isso</div>
                    ...
                    <div className="mt-3 text-[12px] text-white/80">Você não precisa acertar. Só escolher o que cabe.</div>
                  </div>
                </div>
              </Reveal>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="rounded-3xl bg-[#fff7fb] border border-[#f5d7e5] p-5">
                        ...
                        <div className="mt-4 flex flex-col sm:flex-row flex-wrap gap-2 items-stretch sm:items-center">
                          ...
                          <button onClick={swapSuggestion} className="btn-secondary">
                            Ver outra opção
                          </button>
                          <button onClick={() => go('pausas')} className="btn-secondary">
                            Só uma pausa rápida
                          </button>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                          ...
                          <button onClick={() => go('para-voce')} className="btn-primary">
                            Concluir
                          </button>
                        </div>
                      </div>
                      ...
                      <div className="rounded-3xl bg-[#fff7fb] border border-[#f5d7e5] p-5">
                        ...
                        <div className="mt-4 flex flex-col sm:flex-row flex-wrap gap-2 items-stretch sm:items-center">
                          <button onClick={() => saveToMyDay(routine.title)} className="btn-primary">
                            Salvar no Meu Dia
                          </button>
                          ...
                          <button onClick={() => go('para-voce')} className="btn-secondary">
                            Finalizar
                          </button>
                        </div>
                      </div>
                  ...
                  {step === 'pausas' ? (
                    <div className="space-y-4">
                      ...
                      <div className="rounded-3xl bg-[#fff7fb] border border-[#f5d7e5] p-6">
                        ...
                        <div className="mt-4 flex flex-col sm:flex-row flex-wrap gap-2 items-stretch sm:items-center">
                          <button onClick={nextPause} className="btn-secondary w-full sm:w-auto">
                            Outra pausa
                          </button>
                          ...
                          <button onClick={() => go('mini-rotina')} className="btn-secondary">
                            Voltar para a ação
                          </button>
                        </div>
                      </div>
