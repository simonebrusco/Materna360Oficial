...
export default function GlobalError({
  ...
  return (
    <div className="bg-[var(--color-page-bg)] min-h-screen flex items-center justify-center p-4">
      <div className="rounded-2xl bg-white border border-white/60 shadow-[0_4px_24px_rgba(47,58,86,0.08)] p-8 max-w-md text-center">
        ...
        <p className="mt-3 text-sm text-support-2">Tente novamente ou ir para a página anterior.</p>
        <Button
          onClick={() => reset()}
          variant="primary"
