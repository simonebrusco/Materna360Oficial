...
export default function HomePage() {
  return (
    <main className="relative">
      {/* HERO */}
      <section className="relative bg-gradient-to-b from-[#ffd8e6] to-white pt-20 pb-16 sm:pt-24 sm:pb-20">
        <div className="mx-auto max-w-5xl px-6 sm:px-8 text-center">
          <div className="text-[40px] sm:text-[48px] mb-3" aria-hidden>
            <span className="drop-shadow-[0_4px_10px_rgba(255,0,94,0.25)]">❤️</span>
          </div>
          <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight text-[#2f3a56]">
            Materna360
          </h1>
          <p className="mt-4 text-base sm:text-lg leading-relaxed text-[#545454] max-w-3xl mx-auto">
          ...
          <div className="mt-3 inline-flex items-center rounded-full border border-white/60 bg-white/60 backdrop-blur px-3 py-1 text-[11px] font-medium text-[#2f3a56] shadow-sm">
