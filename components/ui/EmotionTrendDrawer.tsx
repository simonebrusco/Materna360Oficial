...
import EmotionTrendChart, {
  EmotionPoint,
} from '@/components/charts/EmotionTrendChart'
...
export default function EmotionTrendDrawer({
  open,
  onClose,
  resolveData,
}: Props) {
  ...
  // Memo correto (sem dependência inútil)
        ...
        <div className="fixed inset-0 z-50">
          ...
          <div
            className="
              ...
              bg-white
              rounded-t-2xl
              shadow-[0_8px_28px_rgba(47,58,86,0.12)]
              p-4 md:p-5
              max-h-[90vh]
              overflow-y-auto
            "
          ...
          >
            ...
            {/* Dica */}
            <p className="m360-micro text-center">
              Dica: observe padrões, sem julgamentos. Foque em pequenas vitórias.
            </p>
          </div>
        </div>
      )}
