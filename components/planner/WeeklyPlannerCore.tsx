              ...
              <SoftCard className="rounded-3xl bg-white/95 border border-[var(--color-soft-strong)] p-4 md:p-6">
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs md:text-sm text-[var(--color-text-muted)]">Compromissos salvos no Materna360 (todos os dias).</p>
                  </div>
                            ...
                            >
                              <div className="flex items-center gap-2">
                                ...
                                <div className="flex flex-col">
                                  <span className="text-sm font-medium text-[var(--color-text-main)]">{appt.title || 'Compromisso'}</span>
            ...
            <SoftCard className="rounded-3xl bg-white border border-[var(--color-soft-strong)] p-4 md:p-5 shadow-[0_16px_60px_rgba(0,0,0,0.18)]">
              <div className="flex items-center justify-between gap-3 mb-3">
                <div>
                  ...
                  <p className="text-[11px] text-[var(--color-text-muted)] mt-0.5">Toque em um dia para selecionar e já criar um compromisso.</p>
                </div>
                    ...
                    {row.map((cell) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {isToday && !isSelected && <span className="absolute left-2 top-2 h-1.5 w-1.5 rounded-full bg-[var(--color-brand)]" />}
