...
export default function AppointmentModal({
  ...
  return (
    <div className="fixed inset-0 z-[999]">
      ...
      {/* Sheet */}
      <div className="absolute inset-x-0 bottom-0 mx-auto w-full max-w-3xl px-4 pb-6 md:pb-8">
        <SoftCard
          className={cx(
            'rounded-[28px] border border-white/35 bg-white/92 backdrop-blur-2xl',
          ...
          <div className="relative p-5 md:p-6">
            ...
            <div className="relative flex items-start justify-between gap-4">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <div className="inline-flex items-center gap-2">
                    <span className="inline-flex rounded-full bg-white/80 border border-[#FFE0F0] px-2.5 py-1 text-[10px] font-semibold tracking-[0.18em] uppercase text-[var(--color-brand)]">
                  ...
                  <h3 className="text-[18px] md:text-[20px] font-semibold text-[var(--color-text-main)] leading-tight">
                    {mode === 'create'
                      ? 'Agende algo importante para você'
                      : 'Ajuste o que precisar com calma'}
                  </h3>

                  <p className="text-[12px] md:text-[13px] text-[var(--color-text-muted)] leading-relaxed max-w-xl">
              ...
              <button
                ...
                onClick={onClose}
                className={cx(
                  'shrink-0 rounded-2xl px-3 py-2 text-sm font-medium',
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <div className="md:col-span-1">
                  <label className="block text-[12px] font-semibold text-[var(--color-text-main)] mb-1">
                    Data
                  </label>
                  <input
                    type="date"
                    ...
                    className={cx(
                      'w-full rounded-2xl border px-4 py-3 text-sm bg-white',
                      'border-[var(--color-soft-strong)]',
                      'focus:outline-none focus:ring-2 focus:ring-[var(--color-brand)]/30 focus:border-[var(--color-brand)]/50',
                    )}
                  />
                  {prettyDate ? (
